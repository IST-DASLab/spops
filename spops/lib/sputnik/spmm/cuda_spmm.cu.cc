...
#include "../memory_aligner.h"
#include "../spmm/compute_utils.h"
#include "../spmm/cuda_spmm.h"
#include "../spmm/dense_tile.h"
#include "../spmm/output_tile.h"
#include "../spmm/predicate_utils.h"
#include "../spmm/sparse_tile.h"
...
#pragma unroll
    ...
    OutputTileSpMM output_tile_storer(m_index, n_index, n, threadIdx.x,
                                  output_fragment, out);
