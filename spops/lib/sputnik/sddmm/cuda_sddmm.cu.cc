...
__CudaSddmmKernel(int m, int k, int n, const int* __restrict__ row_indices,
...
cudaError_t CudaSddmmEx(
  ...
  // AT_DISPATCH_FLOATING_TYPES(torch::kFloat, "sddmm_cuda", ([&] {
  //   CudaSddmmKernel<LoadType, kBlockItemsY, kBlockItemsK, kBlockItemsX,
  //                 kBlockWidth, kPredicateK><<<grid_dim, block_dim>>>(
