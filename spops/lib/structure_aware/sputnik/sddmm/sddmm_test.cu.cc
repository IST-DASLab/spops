...
typedef ::testing::Types<
    Problem<1, 4, 2, 1 * 2>,            // Basic functionality
    ...
    Problem<512, 512, 512, 512 * 512>, // 1k rnn bwd wrt w, bs 80
...
REGISTER_TILED_TESTCASE(CudaSddmmExTest, CudaSddmmExTest, float, 1, 32, 32, 32);
REGISTER_TILED_TESTCASE(CudaSddmmExTest, CudaSddmmExTest, float2, 2, 32, 32, 16);
REGISTER_TILED_TESTCASE(CudaSddmmExTest, CudaSddmmExTest, float4, 4, 32, 32, 8);
